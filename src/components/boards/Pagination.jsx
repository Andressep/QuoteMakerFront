  ...
  return (
    <nav aria-label="Page navigation example">
      <ul className="inline-flex -space-x-px text-base h-10">
        ...
        <li>
          <a href="#" aria-current="page" className="flex items-center justify-center px-4 h-10 text-gray-500 border bg-white border-gray-300  hover:bg-gray-100 hover:text-gray-700">3</a>
        </li>
        <li>
